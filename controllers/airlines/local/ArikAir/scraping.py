...
def scrape_flights_data(link: str) -> List[Dict[str, str]]:
    ...
    try:
        ...
        for WebElement in flight_rows:
            ...
            economy_price += flight_box4.find("span", {"class": "price-best-offer"}).text.strip() if flight_box4.find("span", {"class": "price-best-offer"}) else "no seat"
            ...
            business_price += flight_box4.find("span", {"class": "price"}).text.strip() if flight_box4.find("span", {"class": "price"}) else "no seat"
